...
// Get Users
router.get('/all', IsAuthenticated_1.default, GetUsers_1.default);
// Register User
router.post('/register', Register_1.default);
// Login User
router.get('/login', Login_1.default);
// Logout User
router.get('/logout', IsAuthenticated_1.default, Logout_1.default);
// User Profile
...
// Get User
router.get('/:id', IsAuthenticated_1.default, GetUser_1.default);
// Put User
