...
// Post Reply
router.post('/', IsAuthenticated_1.default, CreateReply_1.default);
// Put Reply
router.put('/:id', IsAuthenticated_1.default, UpdateReply_1.default);
// Delete Reply
router.delete('/', IsAuthenticated_1.default, DeleteReply_1.default);
