...
exports.default = (0, AsyncHandler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let user = yield User_1.default.findById(req['authorizedUser']._id).select('followers name _id');
    ...
    const userIndex = (_a = following === null || following === void 0 ? void 0 : following.followings) === null || _a === void 0 ? void 0 : _a.findIndex((f) => f.toString() === req['authorizedUser']._id);
    if (userIndex)
    ...
    //* Following The User
    (_c = following === null || following === void 0 ? void 0 : following.followings) === null || _c === void 0 ? void 0 : _c.push(req['authorizedUser']._id);
