...
exports.default = (0, AsyncHandler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!reel)
        return next(new ErrorHandler_1.default(404, 'this reel not exists'));
    yield (0, ToggleExpression_1.default)(res, next, userId, user, reel, reelId, 'reels', prevExpressionName, currentExpressionName);
}));
