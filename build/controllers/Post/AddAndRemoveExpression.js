...
exports.default = (0, AsyncHandler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!post)
        return next(new ErrorHandler_1.default(404, 'this post not exists'));
    yield (0, ToggleExpression_1.default)(res, next, userId, user, post, postId, 'posts', prevExpressionName, currentExpressionName);
}));
